                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="birthday" data-provide="datepicker" type="text" class="form-control @error('birthday') is-invalid @enderror" name="birthday" value="{{ old('birthday', isset($user) ? $user->birthday : '')}}" data-date="{{old('birthday', date('d/m/Y', strtotime(isset($user) ? $user->birthday : '')))}}" required autocomplete="birthday" autofocus>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-4">
                                    <div class="form-group">
